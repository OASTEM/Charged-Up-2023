...
public class CubeNoBalance extends SequentialCommandGroup {
  /** Creates a new CubeAuto.*/
  public CubeNoBalance(Arm arm, Manipulator manipulator, DriveTrain driveTrain, ShuffleBoard shuffleboard, Pivot pivot) {
