...
public class Arm extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // SmartDashboard.putNumber("side open ramp rate",
    // sideMotor.getOpenLoopRampRate());
    // SmartDashboard.putNumber("side closed ramp rate",
    // sideMotor.getClosedLoopRampRate());
    // SmartDashboard.putNumber("arm open ramp rate",
    // armMotor.getOpenLoopRampRate());
    // SmartDashboard.putNumber("arm closed ramp rate",
    // armMotor.getClosedLoopRampRate());
  }
}
