...
public final class Constants {
  public static class CANIDS{
    public static final int DRIVETRAIN_FRONT_RIGHT = 2; //8 //practice bot: 3
    public static final int DRIVETRAIN_BACK_RIGHT = 3; //9 //practice bot: 2
    public static final int DRIVETRAIN_FRONT_LEFT = 0; // 7  //practice bot: 1
    public static final int DRIVETRAIN_BACK_LEFT = 1; //6  //practice bot: 0
