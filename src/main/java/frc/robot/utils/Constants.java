...
public final class Constants {
  ...
  public final static class Arm {
    public static final PID upPID = new PID(0.012, 0.0000001, 0, 0.00005, 0); // TODO fix these pid values
    ...
    public static final double ARM_START_POSITION = 174798;
    ...
    public static final double ARM_TOL = 2000;
